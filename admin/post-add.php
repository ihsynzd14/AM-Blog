                                      ...
                                      <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            elseif($_SESSION['auth_role'] == 0 || $_SESSION['auth_role'] == 2 ){
                                              $blog="SELECT b.* FROM blogs b,utenti u WHERE b.status='0' AND b.b_uid = u.uid AND b.b_uid = $uidCorrente ";
                                              $blog_run = mysqli_query($con,$blog);  
                                            }
                                                        ...
                                                        <option value="">-- Scegli Blog --</option>
                                                            ...
                                                            foreach($blog_run as $blogx){
                                                                ?>
                                                                        ...
                                                                        <?= $blogx['bid'] == $p_bid ? 'selected' : '' //se blog id uguale post blog id che fate modifica fai selezionato altrimenti non fai nulla ?>>
                                                                        <?= $blogx['nome'];?></option>
                                                                <?php
                                                            }
                                                            ?>
